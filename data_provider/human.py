...
class InputHandle:
    ...
    def begin(self, do_shuffle=True):
        ...
        self.current_position = 0
        self.current_batch_indices = self.indices[self.current_position:self.current_position + self.mini_batch_size]

    def next(self):
        self.current_position += self.mini_batch_size
    ...
    def print_stat(self):
        ...
        logger.info("    Minibatch Size: " + str(self.mini_batch_size))
