from data_provider import mnist,  human, taxibj
...
def data_provider(dataset_name, train_data_paths, valid_data_paths, batch_size,
    ...
    if dataset_name == 'human':
        input_param = {'paths': valid_data_list,
                       ...
                       'input_data_type': 'float32',
                       'name': 'human'}
        input_handle = human.DataProcess(input_param)
    ...
    if dataset_name == 'taxibj':
        input_param = {'paths': valid_data_list,
                       ...
                       'seq_length': seq_length,
                       'input_data_type': 'float32',
                       'name': 'taxibj iterator'}
        input_handle = taxibj.DataProcess(input_param)
